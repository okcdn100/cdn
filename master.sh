...
cd /opt/
download "https://github.com/okcdn100/cdn/raw/main/master/$tar_gz_name" "https://github.com/okcdn100/cdn/raw/main/master/$tar_gz_name" "$tar_gz_name"
